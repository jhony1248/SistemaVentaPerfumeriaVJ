...
public class BuscarProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        COMBOOPCION.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "ID", "Marca" }));
    ...
    private void TbBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TbBuscarMouseClicked
        ...
        //enviar los datos a ventas
        Ventas.IdProducto = TbBuscar.getValueAt(TbBuscar.getSelectedRow(),0).toString();
        ...
        Ventas.txtProducto.setText(NombrePro + " || " + MarcaPro);
        Ventas.txtStock.setText(TbBuscar.getValueAt(TbBuscar.getSelectedRow(),5).toString());
        Ventas.txtContenidoNeto.setText(TbBuscar.getValueAt(TbBuscar.getSelectedRow(),3).toString());
        Ventas.txtPrecio.setText(TbBuscar.getValueAt(TbBuscar.getSelectedRow(),6).toString());       
